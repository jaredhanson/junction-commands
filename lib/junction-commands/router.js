...
Router.prototype._route = function(action, node, callbacks) {
  ...
  // TODO: Implement support for acception an array of additional actions to
  //       alias this route to.  For example, the following API:
  //  app.execute(['next', prev'], 'doCommand', function(req, res, next){...});
